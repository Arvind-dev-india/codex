...
use crate::tool_config::create_recovery_services_tools;
use crate::recovery_services_bridge;
...
impl MessageProcessor {
    ...
    async fn handle_initialize(&mut self, id: RequestId, params: InitializeRequestParams) {
        ...
        let result = InitializeResult {
            ...
            instructions: Some("Recovery Services Server - Manage Azure Backup vaults, policies, and backup operations".to_string()),
            protocol_version: params.protocol_version,
            server_info: Implementation {
                name: "recovery-services-server".to_string(),
    ...
    async fn handle_call_tool(&self, id: RequestId, params: CallToolRequestParams) {
        ...
        let result = match recovery_services_bridge::call_recovery_services_tool(&params.name, arguments).await {
            ...
            Err(e) => CallToolResult {
                content: vec![CallToolResultContent::TextContent(TextContent {
                    r#type: "text".to_string(),
                    text: format!("Error calling Recovery Services tool: {}", e),
                    annotations: None,
                })],
                is_error: Some(true),
            },
